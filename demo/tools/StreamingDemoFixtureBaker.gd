...
# [b]Fixture Paths[/b]
# Keeps the generated resource contract stable for tests and web exports.
...
# [b]Fixture Configuration[/b]
# Fixed values make the validation terrain reproducible across local and CI bakes.
...
# [b]Baking[/b]
# Exercises the same field, meshing, and chunk-asset pipeline used by offline content.
