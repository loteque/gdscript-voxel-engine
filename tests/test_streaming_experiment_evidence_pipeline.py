...
class StreamingExperimentEvidencePipelineTests(unittest.TestCase):
    def test_streaming_preview_identifies_lifecycle_experiment(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("CORRECT TEST: ChunkStreamer Lifecycle Experiment", html)
            self.assertIn("streaming-experiment-", html)
